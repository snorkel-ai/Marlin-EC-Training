    ...
    <div className="landing-page">
      ...
      <main className="main-content">
        <section className="overview-section">
          ...
          {/* Workflow image */}
          <div style={{ width: '100%', maxWidth: '70vw', margin: '2rem auto' }}>
          ...
          <CollapsiblePhase title="Step 4: CLI Setup (one-time)">
            <div className="phase-item">
              ...
              <h4 style={{ marginTop: '1.5rem', marginBottom: '0.75rem', fontSize: '1.125rem', fontWeight: 600, color: '#334155' }}>Operating System Requirements</h4>
              <p style={{ color: '#475569', lineHeight: '1.7', marginBottom: '0.5rem' }}>You must use macOS or Linux.</p>
              <p style={{ color: '#475569', lineHeight: '1.7', marginBottom: '1.5rem' }}>Windows is not supported unless you can run Linux reliably.</p>
              
              <h4 style={{ marginTop: '1.5rem', marginBottom: '0.75rem', fontSize: '1.125rem', fontWeight: 600, color: '#334155' }}>Required Tools</h4>
              <p style={{ color: '#475569', lineHeight: '1.7', marginBottom: '0.75rem' }}>You need the following installed and working before you start:</p>
              <ul style={{ color: '#475569', lineHeight: '1.7', marginBottom: '1rem', paddingLeft: '1.5rem' }}>
                <li>VS Code, with the <code style={{ backgroundColor: '#f1f5f9', padding: '0.125rem 0.375rem', borderRadius: '4px', fontSize: '0.9em' }}>code</code> command available in your terminal (added to PATH)</li>
          ...
          {/* Onboarding Video */}
          <CollapsiblePhase title="Onboarding Video">
            <div className="phase-item">
              <p>Watch the onboarding session to get started with Project Marlin.</p>
              <div style={{ marginTop: '1.5rem' }}>
