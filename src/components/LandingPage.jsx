      ...
      <main className="main-content">
        <section className="overview-section">
          ...
          <div className="resource-buttons">
            ...
            <button className="resource-button" onClick={() => onNavigate('modelworkspace')}><span className="button-text">Step 4: CLI and Final Submission</span><span className="button-description">Shows how to run the model, iterate across turns, review updates, and finalize your submission.</span></button>
            ...
            <div style={{ display: 'flex', gap: '2rem', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '3rem' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', maxWidth: '550px', minWidth: '480px', width: '100%' }}>
                <div style={{ background: 'linear-gradient(135deg, #1e40af 0%, #3b82f6 100%)', borderRadius: '12px', padding: '2rem', boxShadow: '0 4px 16px rgba(0, 0, 0, 0.15)', width: '100%' }}>
                  <h3 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#ffffff', marginBottom: '1.5rem', textAlign: 'center' }}>Onboarding Session 1</h3>
                  <div>
                    <h4 style={{ fontSize: '1.125rem', fontWeight: 600, color: '#ffffff', marginBottom: '1rem', textAlign: 'center' }}>Onboarding Video</h4>
                    <div className="video-wrapper">
                      <video controls preload="metadata" className="video-iframe" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'contain' }}>
